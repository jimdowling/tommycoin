...
Route::prefix('buy')->name('buy.')->group(function () {
    ...
    Route::get('/cancel',  [BuyController::class, 'cancel'])->name('cancel');
});

// Stripe webhook — excluded from CSRF in bootstrap/app.php
Route::post('/stripe/webhook', [BuyController::class, 'webhook'])->name('stripe.webhook');

// Mock live price endpoint
